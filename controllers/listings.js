...
module.exports.index = async (req, res) => {
  ...
  if(search){
    ...
    const allListing = await Listing.find( {$or: [ {title: regex}, {country: regex}, { description: regex}, {location: regex} ] });
    return res.render('listings/index.ejs', { allListing, category });
  }
